...
(function (module) {
    ...
    class Bot {
        ...
        loadMenu() {
            ...
            // 加载文档
            axios.get(this.options.source_url + '/9.x', this.axios_options).then((response) => {
            ...
            // 加载速查表
            axios.get('https://learnku.com/docs/laravel-cheatsheet/9.x', this.axios_options).then(response => {
                const dom = $.load(response.data);
